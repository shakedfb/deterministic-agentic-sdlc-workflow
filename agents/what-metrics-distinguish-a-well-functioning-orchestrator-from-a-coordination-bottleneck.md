...
- [[specific-escalation-patterns-in-production-agentic-sdlc-systems]] — the orchestrator's escalation behavior is measurable via escalation rate; over- and under-escalation are both diagnostic signals
